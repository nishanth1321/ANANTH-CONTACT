...
//             <h1 className="mb-6 font-serif text-3xl font-bold text-center text-red-600 md:text-left">
//               A T R Sivakumar
//             </h1>

//             <div className="mb-8 text-gray-800">
//               <p className="text-xl font-semibold">Founder & CEO - Ananth Textiles</p>
//             </div>

//             {/* Founder Description */}
//             <p className="text-lg text-gray-800">
//               Since 1997, A T R Sivakumar has
//               been the driving force behind its growth and success in the
//               textile industry. His vision and commitment to quality have
